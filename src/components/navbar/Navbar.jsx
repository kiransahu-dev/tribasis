...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="absolute left-0 top-[70px] w-full bg-violet-900 text-white shadow-lg md:hidden">
          <ul className="flex flex-col gap-4 p-6">
            ...
            {/* Call Section */}
            <li className="flex items-center gap-3 border-t border-white/30 pt-4">
